...
(function ($) {
    ...
    $.ias = function (options)
    {
        ...
        function paginate(curScrOffset, onCompleteHandler)
        {
			...
			alert("paginate: "+urlNextPage.split("/")[urlNextPage.split("/").length-1]);
			paging.setpage(urlNextPage.split("/")[urlNextPage.split("/").length-1],urlNextPage)
/*
    ...
    $.ias.history = function ()
    {
        ...
        this.pushState = function (stateObj, title, url)
        {
            ...
            if (isHtml5) {
                ...
                hash = (stateObj.page > 0 ? (chash!="" ? chash+'?page=' + stateObj.page : '#/page/' + stateObj.page) : '');
